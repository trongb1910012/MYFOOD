        ...
        <div class="hero-inner">
            <div class="container text-center hero-text font-white">
                ...
                <div class="banner-form">
                     <form class="form-inline" action="search2.php" method="post">
                        ...
                        <button /*onclick="location.href='restaurants.php'"*/ type="submit" class="btn theme-btn btn-lg" >Tìm kiếm</button>
                    </form> 
                </div>
            </div>
        </div>
