       ...
       $result = mysqli_query($db,"SELECT id FROM admin_codes WHERE codes =  '".$_POST['code']."'");  //query to select the id of the valid code enter by user! 
                     ...
                     if(mysqli_num_rows($result) == 0)     //if code is not valid
                      ...
                      else                                 //if code is valid 
					     {
								...
								mysqli_query($db, $mql);
									$success = "Đăng ký thành công tài khoản admin!!";
						 }
        }
	}
...
<div class="container">
  <div class="info">
    <h1>MY.FOOD</h1><span>Đăng nhập</span>
  </div>
</div>
<div class="form">
  ...
  <form class="register-form" action="index.php" method="post">
   ...
   <input type="submit"  name="submit1" value="Đăng ký" />
    <p class="message">Đã có tài khoản <a href="#">Đăng nhập tại đây</a></p>
  </form>
  ...
  <form class="login-form" action="index.php" method="post">
    ...
    <p class="message">Chưa có tài khoản admin? <a href="#">Đăng ký tại đây</a></p>
  </form>
