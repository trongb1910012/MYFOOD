...
if(isset($_POST['submit']))           //if upload btn is pressed
{
		...
		{	
											$error = 	'<div class="alert alert-danger alert-dismissible fade show">
																...
																<strong>Điền các ô còn trống!!</strong>
															</div>';
									...
									if($fsize>=1200000)
										{
												...
												$error = 	'<div class="alert alert-danger alert-dismissible fade show">
																<button type="button" class="close" data-dismiss="alert" aria-label="Close"><span aria-hidden="true">&times;</span></button>
																<strong>Hình có dung lượng quá lớn!</strong> Thử hình khác.
															</div>';
        ...
        <div class="page-wrapper" style="height:1200px;">
            ...
            <div class="row page-titles">
                <div class="col-md-5 align-self-center">
                    <h3 class="text-primary">Cập nhật món ăn</h3> </div>
                ...
                <!-- Start Page Content -->
                        ...
                        <div class="card card-outline-primary">
                            <div class="card-header">
                                <h4 class="m-b-0 text-white">Cập nhật món ăn</h4>
                            </div>
                            <div class="card-body">
                                        ...
                                        <div class="row p-t-20">
                                            <div class="col-md-6">
                                                <div class="form-group">
                                                    ...
                                                    <input type="text" name="price" value="<?php echo $roww['price'];?>"  class="form-control" placeholder="đ">
                                                   </div>
                                            </div>
                                            <!--/span-->
                                            <div class="col-md-6">
