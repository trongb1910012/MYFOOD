        ...
        <div class="page-wrapper">
            ...
            <div class="row page-titles">
                <div class="col-md-5 align-self-center">
                    <h3 class="text-primary">Danh sách người dùng</h3> </div>
																	...
																	while($rows=mysqli_fetch_array($query))
																		{
																					...
																					echo ' <tr><td>'.$rows['username'].'</td>
																								...
																								<td>'.$rows['date'].'</td>
                                                                                                     ...
                                                                                                     <a href="userprofile.php?u_id='.$rows['u_id'].'" " class="btn btn-info btn-flat btn-addon btn-sm m-b-10 m-l-5"><i class="ti-info"></i></a>
                                                                                                     </td></tr>
                                                                                                    ';
