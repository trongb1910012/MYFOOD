    ...
    <div style="margin-left:50px;">
      <form name="updateticket" id="updatecomplaint" method="post">
        ...
        <table border="0" cellspacing="0" cellpadding="0">
          ...
          $ret2 = mysqli_query($db, "select * FROM users where u_id='" . $_GET['u_id'] . "'");
          ...
          ?>
            ...
            <tr>
              <td colspan="2"><b>Thông tin của người dùng :<?php echo $row['username']; ?></b></td>
            ...
            <tr height="50">
              ...
              <td><?php if ($row['status'] == 1) {
                    echo "<div class='btn btn-success'>Còn hoạt động</div>";
                  } else {
                    echo "<div class='btn btn-danger'>Đã bị chặn</div>";
                  }
                  ?></td>
            </tr>
