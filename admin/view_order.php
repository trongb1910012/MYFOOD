                ...
                <nav class="sidebar-nav">
                    <ul id="sidebarnav">
                        ...
                        <li> <a class="has-arrow  " href="#" aria-expanded="false">  <span><i class="fa fa-user f-s-20 "></i></span><span class="hide-menu">Người dùng</span></a>
                            <ul aria-expanded="false" class="collapse">
                                <li><a href="allusers.php">Danh sách người dùng</a></li>
								<li><a href="add_users.php">Thêm người dùng</a></li>
								
                               
                            </ul>
                        </li>
                        <li> <a class="has-arrow  " href="#" aria-expanded="false"><i class="fa fa-archive f-s-20 color-warning"></i><span class="hide-menu">Loại món ăn</span></a>
                            <ul aria-expanded="false" class="collapse">
								<li><a href="allrestraunt.php">Danh sách loại</a></li>
                                <li><a href="add_restraunt.php">Thêm loại</a></li>
                      ...
                      <li> <a class="has-arrow  " href="#" aria-expanded="false"><i class="fa fa-cutlery" aria-hidden="true"></i><span class="hide-menu">Món ăn</span></a>
						 ...
						 <li> <a class="has-arrow  " href="#" aria-expanded="false"><i class="fa fa-shopping-cart" aria-hidden="true"></i><span class="hide-menu">Quản lý đơn hàng</span></a>
                            <ul aria-expanded="false" class="collapse">
								<li><a href="all_orders.php">Đơn hàng</a></li>
        ...
        <div class="page-wrapper">
            ...
            <div class="row page-titles">
                <div class="col-md-5 align-self-center">
                    <h3 class="text-primary">Thông tin đơn hàng</h3> </div>
                                        ...
                                        <tbody>
                                           <?php
											...
											<tr>
												<td><strong>Món ăn:</strong></td>
												    <td><center><?php echo $rows['title']; ?></center></td>
													    <td><center>
													   <a href="javascript:void(0);" onClick="popUpWindow('userprofile.php?u_id=<?php echo htmlentities($rows['u_id']);?>');" title="Update order">
														<button type="button" class="btn btn-primary">Chi tiết người dùng</button></a>
											...
											<tr>
												    ...
												    <td><center><?php echo $rows['price']; ?>đ</center></td>
											...
											<tr>
													...
													<?php 
																			...
																			{
																			?>
																			<td> <center><button type="button" class="btn btn-info" style="font-weight:bold;"><span class="fa fa-bars"  aria-hidden="true" >Đang chờ</button></center></td>
																		   <?php 
																			  }
																			...
																			if($status=="closed")
																				{
																			?>
																			<td>  <center><button type="button" class="btn btn-success" ><span  class="fa fa-check-circle" aria-hidden="true">Đã giao</button></center></td> 
																			<?php 
																			} 
																			?>
																			<?php
