...
if(isset($_POST['submit']))           //if upload btn is pressed
{
	...
	else
		{
				...
				$fname = $_FILES['file']['name'];
								...
								$store = "../images/product/".basename($fnew);                      // the path to store the upload image
									...
									if($fsize>=1200000)
										{
												...
												$error = 	'<div class="alert alert-danger alert-dismissible fade show">
																<button type="button" class="close" data-dismiss="alert" aria-label="Close"><span aria-hidden="true">&times;</span></button>
																<strong>Ảnh quá lớn</strong> Xin dùng ảnh khác.
															</div>';
									...
									else
										{
												...
												move_uploaded_file($temp, $store);
													...
													$success = 	'<div class="alert alert-success alert-dismissible fade show">
																<button type="button" class="close" data-dismiss="alert" aria-label="Close"><span aria-hidden="true">&times;</span></button>
																<strong>Congrats!</strong> Thêm thành công món mới
															</div>';
					...
					elseif($extension == '')
					{
						$error = 	'<div class="alert alert-danger alert-dismissible fade show">
											...
											$error = 	'<div class="alert alert-danger alert-dismissible fade show">
																<button type="button" class="close" data-dismiss="alert" aria-label="Close"><span aria-hidden="true">&times;</span></button>
																<strong>Khng hợp lệ</strong>chỉ file png, jpg.
															</div>';
                                        ...
                                        <div class="row p-t-20">
                                            <div class="col-md-6">
                                                <div class="form-group">
                                                    ...
                                                    <input type="text" name="d_name" class="form-control" placeholder="Tên món">
                                                   </div>
                                            </div>
                                            <!--/span-->
                                            <div class="col-md-6">
                                                <div class="form-group has-danger">
                                                    ...
                                                    <input type="text" name="about" class="form-control form-control-danger" placeholder="Cay,ngọt,vv ;)">
                                                    </div>
                                            </div>
                                            <!--/span-->
                                        </div>
                                        ...
                                        <div class="row p-t-20">
                                            <div class="col-md-6">
                                                <div class="form-group">
                                                    ...
                                                    <input type="text" name="price" class="form-control" placeholder="đ">
                                                   </div>
                                            </div>
                                            <!--/span-->
                                            <div class="col-md-6">
