        ...
        <div class="page-wrapper">
            ...
            <div class="row page-titles">
                <div class="col-md-5 align-self-center">
                    <h3 class="text-primary">Đơn hàng</h3> </div>
																	...
																	while($rows=mysqli_fetch_array($query))
																		{
																			...
																			{
																			?>
																			<td> <button type="button" class="btn btn-info" style="font-weight:bold;"><span class="fa fa-bars"  aria-hidden="true" >Đang chờ</button></td>
																		   <?php 
																			  }
																			...
																			if($status=="closed")
																				{
																			?>
																			<td> <button type="button" class="btn btn-success" ><span  class="fa fa-check-circle" aria-hidden="true">Đã giao</button></td> 
																			<?php 
																			} 
																			?>
																			<?php
																			...
																			?>
																						<?php																									
																							...
																							?>
																									 <td>
																									 <a href="delete_orders.php?order_del=<?php echo $rows['o_id'];?>" onclick="return confirm('Bạn có muốn xóa đơn hàng này?');" class="btn btn-danger btn-flat btn-addon btn-xs m-b-10"><i class="fa fa-trash-o" style="font-size:16px"></i></a> 
																								<?php
