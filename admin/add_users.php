...
if(isset($_POST['submit'] ))
{
	...
	elseif(strlen($_POST['password']) < 6)
	{
		$error = '<div class="alert alert-danger alert-dismissible fade show">
																<button type="button" class="close" data-dismiss="alert" aria-label="Close"><span aria-hidden="true">&times;</span></button>
																<strong>Mật khẩu phải không ít hơn 6 ký tự!</strong>
															</div>';
	}
	...
	elseif(strlen($_POST['phone']) < 10)
	{
		$error = '<div class="alert alert-danger alert-dismissible fade show">
																<button type="button" class="close" data-dismiss="alert" aria-label="Close"><span aria-hidden="true">&times;</span></button>
																<strong>Số điện thoại ko hợp lệ</strong>
															</div>';
	}
	...
	mysqli_query($db, $mql);
			$success = 	'<div class="alert alert-success alert-dismissible fade show">
																<button type="button" class="close" data-dismiss="alert" aria-label="Close"><span aria-hidden="true">&times;</span></button>
																<strong>Congrats!</strong> Đã thêm thành công người dùng mới.</br></div>';
            ...
            <div class="scroll-sidebar">
                ...
                <nav class="sidebar-nav">
                    <ul id="sidebarnav">
                        ...
                        <li> <a class="has-arrow  " href="#" aria-expanded="false">  <span><i class="fa fa-user f-s-20 "></i></span><span class="hide-menu">Quản lý người dùng</span></a>
                            <ul aria-expanded="false" class="collapse">
                       ...
                       <li> <a class="has-arrow  " href="#" aria-expanded="false"><i class="fa fa-cutlery" aria-hidden="true"></i><span class="hide-menu">Món ăn</span></a>
						 ...
						 <li> <a class="has-arrow  " href="#" aria-expanded="false"><i class="fa fa-shopping-cart" aria-hidden="true"></i><span class="hide-menu">Quản lý đưn hàng</span></a>
                            <ul aria-expanded="false" class="collapse">
								<li><a href="all_orders.php">Danh sách đơn hàng</a></li>
                                    ...
                                    <div class="form-body">
                                        ...
                                        <!--/row-->
										 <div class="row">
                                            ...
                                            <!--/span-->
                                            <h3 class="box-title m-t-40">Địa chi</h3>
                                        <hr>
                                        <div class="row">
                                            <div class="col-md-12 ">
                                                <div class="form-group">
